...
*   ./getVcode.php  //	获取验证图片，GET 方法，建议加上伪参数rand

####	**建立**
----------------
*   ./newVideo.php  //  创建视频信息，POST方法，参数btih
*   ./newLink.php   //  创建链接信息，POST方法，参数linkage
*   ./newComment.php//  创建弹幕信息，POST方法，参数btih,comment
...
####	**关于getVideo**
----------------
*	按时间倒序取最近七天数据: `bith=0000000000000000000000000000000000000000&action=time`
*	按播放排行取最近七天数据: `bith=0000000000000000000000000000000000000000&action=view`
*	按弹幕排行取最近七天数据: `bith=0000000000000000000000000000000000000000&action=reply`
*	取某视频: : `bith=0000000000000000000000000000000000000000`
暂不支持jsonP,视需求决定添加

####	**关于getComment**
----------------
*	按序号获取: `bith=0000000000000000000000000000000000000000&action=cid&start=cid_start&end=cid_end`
*	按时间获取: `bith=0000000000000000000000000000000000000000&action=time&start=time_start&end=time_end`
*	某号及以后: `bith=0000000000000000000000000000000000000000&action=recent&start=cid_start`
*	最后多少条: `bith=0000000000000000000000000000000000000000&action=time&count=count`
*	获取全弹幕: `bith=0000000000000000000000000000000000000000`
暂不支持jsonP,视需求决定添加
